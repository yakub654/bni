...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
  <div class="page-wrapper">
    ...
    <div class="portlet-body form">
      <!-- BEGIN FORM-->
      <form class="horizontal-form" id="transForm" metthod="post">
      <div class="form-body">
        <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                    <label >Reference Type</label>
                    <select class="form-control select2" id="types" name="types">
                        <option value="">Select your Reference type</option> 
      ...
      <div class="form-actions btn-group">
          <button type="submit" class="btn green pull pull-right">Submit</button>
          <button type="button" class="btn red pull pull-right ">Cancel</button>
      </div>
    </form>
  </div>
</div>
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS -->
       ...
       <script src="<?php echo site_url() ?>assets/pages/scripts/transForm.js" type="text/javascript"></script>
